export const permissionCatalog = [
  { key: "master_data.read", description: "회사·사업장 기준정보 조회" },
  { key: "master_data.manage", description: "회사·사업장 기준정보 관리" },
  ...
  { key: "pricing.read", description: "가격등급·가격표와 계산 결과 조회" },
  { key: "pricing.write", description: "가격등급·가격표 작성" },
  { key: "pricing.approve", description: "가격표 검토·게시" },
