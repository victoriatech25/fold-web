...
> 상태: `VERIFYING` — B11-1~4 구현 완료(2026-09-12). [화면 테스트 가이드](../P2-B11-screen-test-guide.md)로 사용자 검수 대기. MFC 실제 DXF 대조(가이드 2-8)는 파일 확보 뒤
>
...
| B11-5 | 검수 가이드 — **2026-09-12 작성**([가이드](../P2-B11-screen-test-guide.md)). 상태 문서 갱신·사용자 검수는 검수 뒤 | — |
...
| 2026-09-12 | B11-5 검수 가이드 작성. 상태 `VERIFYING` | Claude |
